...
public class Administrador extends javax.swing.JFrame {
    ...
    public Administrador() {
        initComponents();
        user = Login.user;
        sesion_usuario = 1; // variable con funcion de bandera(boolean)

        this.setSize(650, 430);
        this.setResizable(false);
        this.setTitle("Administrador/ admin: " + user);
        ...
        // Codigo para ingresar a la base de datos.
        try {
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement("select nombre_usuario from usuarios where username = '" + user + "'");

            ResultSet rs = pst.executeQuery(); // metodo para obtener lo que se ejecuto hacia la BD.
            ...
            System.err.println("ERROR!!! error desde la interfaz de administrador");
        }
    }

    /*
     Metodo que permite cambiar el icono de la interfaz.
     IMPORTANTE guardar este metodo, ya que es un metodo general
     me servira para cualquier otro proyecto. :) 
     */
    ...
    /*
     Metodo que se ejecuta al "oprimir" el boton para registar un usaurio.
     Desplegar interfaz RegistrarUsuaros
     */
