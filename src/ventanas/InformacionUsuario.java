...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    public InformacionUsuario() {
        ...
        this.setTitle("Información del usuario " + user_update + "// usuario: " + user);
        ...
        jLabel__Titulo.setText("Informacion del usuario " + user_update);
        ...
        try {
            ...
            System.err.println("Error en cargar usuario\n"
                    + "ERROR: " + e);
    ...
    private void initComponents() {
        ...
        jLabel__Titulo = new javax.swing.JLabel();
        ...
        jLabel_RegistoPor = new javax.swing.JLabel();
        ...
        jLabel__Titulo.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel__Titulo.setForeground(new java.awt.Color(255, 255, 255));
        jLabel__Titulo.setText("Informacio del Usuario");
        getContentPane().add(jLabel__Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, -1, -1));
        ...
        jLabel_RegistoPor.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_RegistoPor.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_RegistoPor.setText("Registrado por:");
        getContentPane().add(jLabel_RegistoPor, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 170, -1, -1));
        ...
        jButton_Actualizar.setBackground(new java.awt.Color(153, 153, 155));
        ...
        jButton_RestaurarPassword.setBackground(new java.awt.Color(153, 153, 155));
        ...
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 420, -1, -1));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        int permios_cmb, estatus_cmb, validacion = 0;
        ...
        permios_cmb = cmb_niveles.getSelectedIndex() + 1;
        ...
        if (validacion == 0) {
            ...
            } else if (permios_cmb == 2) {
                permisos_string = "Capturista";
            } else if (permios_cmb == 3) {
    ...
    private javax.swing.JLabel jLabel_RegistoPor;
    private javax.swing.JLabel jLabel_Telefono;
    private javax.swing.JLabel jLabel_Username;
    private javax.swing.JLabel jLabel_Wallpaper;
    private javax.swing.JLabel jLabel__Titulo;
